...
*** MODIFIED FOR HOTSPOT: Changed /capture and /inference from POST to GET
    to allow requests through mobile/laptop hotspots with AP Isolation.
***
"""
...
<body>
    ...
    <script>
        ...
        async function sendToDataHub() {
            ...
            try {
                // NOTE: Kept POST for this one, as it sends data.
                // If this also fails, change it to a GET request
                // and modify the Python @app.route('/send_datahub')
